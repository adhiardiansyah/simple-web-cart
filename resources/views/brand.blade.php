...
@section('title', 'Toko Adhi | '.$brand->name)
@section('content')
  ...
  <div class="container-fluid p-md-5">
    <div class="d-flex align-items-center mt-2 mt-md-0">
      ...
      <div class="overflow-auto">
        @foreach ($brands as $b)
        <a href="/brand/{{ $b->id }}" class="btn btn-sm btn-primary rounded-pill ms-1">{{ $b->name }}</a>
        @endforeach
      </div>
    </div>
    <hr>
      ...
      <a class="col-md-2 text-dark text-decoration-none mb-4 card-item d-flex align-items-stretch"
        ...
        <div class="col-12 card p-3 shadow-sm border-0">
          ...
          <div class="d-flex">
            ...
            <form action="/add-to-cart" method="POST" class="ms-auto"> @csrf
