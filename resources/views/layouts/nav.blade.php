  ...
  ?>
    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdown" role="button" data-display="static"
          data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: black">
          <img class="img-profile rounded-circle" width="20px" src="{{ asset('img') }}/{{ Auth::user()->user_image }}">
          {{ Auth::user()->name }}
        </a>
